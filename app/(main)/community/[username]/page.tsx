...
const FoundUsers = () => {
  ...
  return (
    <div className="p-16 flex flex-col gap-4">
        ...
        <div key={user.clerkId} className="bg-black p-4 flex gap-4 items-center justify-between  h-[20vh] shadow-xl w-[800px] rounded-xl  hover:-translate-y-1  transition-transform ">
